...
dm_params=(
    ...
    `add_virtual_device                       3 virtio-input Device name: Logitech USB Optical Mouse, Device physical path: usb-0000:00:14.0-3/input0`
    `add_virtual_device                       4 virtio-net tap=WaaG,mac_seed=${mac:0:17}-VM1`
    `add_virtual_device                       5 virtio-blk ./waag-21h2.img`
